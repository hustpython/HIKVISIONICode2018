...
import socket
import json
# python main.py 39.107.126.155 31529 fe3b84ce-d25f-4754-ba8b-d1b3a00bdeb0
# 0,F1,100
# 1,F3,20
# 2,F3,20
# 3,F4,30
...
class Algo():
    ...
    def goodchooseuav(self,good):
        dis=[good["value"]/(40*(abs(good["start_x"] - FlyPlane["x"])+abs(good["start_y"] - FlyPlane["y"])+\
    ...
    def uavchoosegood(self,uav):
        dis=[good["value"]/(40*(abs(good["start_x"] - uav["x"])+abs(good["start_y"] - uav["y"])+\
